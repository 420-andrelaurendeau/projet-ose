...
public class InterviewController {
    ...
    public ResponseEntity<Page<InterviewDTO>> getInterviewsByStudentId(@PathVariable long studentId,
        ...
        logger.info("Interview get request received");
        return Optional.of(interviewService.getInterviewsByStudentId(studentId, page, size,sortField, sortDirection, season)).map(ResponseEntity::ok).orElse(ResponseEntity.notFound().build());
    }
