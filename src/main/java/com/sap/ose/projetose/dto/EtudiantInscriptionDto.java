...
public class EtudiantInscriptionDto extends UtilisateurInscriptionDto {
    ...
    public EtudiantInscriptionDto(String nom, String prenom, String phone, String email, String password, String matricule, long programme, List<File> cv, List<Long> internships_id) {
