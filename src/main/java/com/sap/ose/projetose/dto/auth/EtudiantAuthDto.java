...
public class EtudiantAuthDto extends UtilisateurAuthDto {
    ...
    public EtudiantAuthDto(String nom, String prenom, String phone, String email,String password, String matricule, long programme_id, List<Long> cv, List<Long> internships_ids) {
