...
public class ProjetOseApplication implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Student studentMarcMax = studentRepository.save(new Student("Marc", "Max", "4387999889", "max@gmail.com", "popo", studyProgramInformatique, "2045888"));
        Student studentLoicLac = studentRepository.save(new Student("Loic", "Lac", "4352996589", "Lac@gmail.com", "popo", studyProgramInformatique, "2045898"));
        Student studentJeanDupont = new Student("Jean", "Dupont", "4387996589", "dupont@gmail.com", "popo", studyProgramAdmnistration, "2045878");


        Employer employerPatriqueLemieux = employerRepository.save(new Employer("Patrique", "Lemieux", "lemieux@gmail.com", "4383006589", "popo123", "popo", Set.of(studyProgramInformatique)));
        Employer employerPierreLacroix = employerRepository.save(new Employer("Pierre", "Lacroix", "lacroix@gmail.com", "4387996589", "popo123", "poo", Set.of(studyProgramAdmnistration)));

        InternshipManager internshipmanager = internshipManagerRepository.save(new InternshipManager("Jean", "Dupont", "4387996589", "dupont@gmail.com", "popo", Set.of(studyProgramInformatique)));

        OfferReviewRequest offerReviewRequest = offerReviewRequestRepository.save(new OfferReviewRequest());

        File fileApplicationMarc = fileRepository.save(new File("Application".getBytes(StandardCharsets.UTF_8), "Application", ApprovalStatus.APPROVED, studentMarcMax));
        File fileOffreInformatique = fileRepository.save(new File("OffreInformatique".getBytes(StandardCharsets.UTF_8), "OffreInformatique", ApprovalStatus.APPROVED, employerPatriqueLemieux));
        File fileOffreAdministration = fileRepository.save(new File("OffreSecurite".getBytes(StandardCharsets.UTF_8), "OffreSecurite", ApprovalStatus.APPROVED, studentMarcMax));

        InternshipOffer internshipOfferInformatique = internshipOfferRepository.save(new InternshipOffer(
                ...
                new ArrayList<>(),
                studyProgramInformatique,
                fileOffreInformatique,
                employerPatriqueLemieux,
                offerReviewRequest));

        InternshipOffer internshipOfferSecurite = internshipOfferRepository.save(new InternshipOffer(
                "Security Guards",
