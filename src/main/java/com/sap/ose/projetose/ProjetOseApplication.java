...
public class ProjetOseApplication implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        Program program1 = studyProgramRepository.save(new Program("Techniques de l'informatique", "Programme de formation en techniques de l'informatique"));
        Program program2 = studyProgramRepository.save(new Program("Techniques de l'administration", "Programme de formation en techniques de l'administration"));
        studyProgramRepository.save(new Program("Techniques de la logistique", "Programme de formation en techniques de la logistique"));
        studyProgramRepository.save(new Program("Techniques de la comptabilité et de la gestion", "Programme de formation en techniques de la comptabilité et de la gestion"));
