...
public class ProjetOseApplication implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Etudiant etudiant2 = new Etudiant("Marc", "Max", "4387999889", "marco.attia17+max@gmail.com", "popo", "2045888", programme1, null);
        Etudiant etudiant3 = new Etudiant("Loic", "Lac", "4352996589", "marco.attia17+lac@gmail.com", "popo", "2045898", programme1, null);
        Employeur employeur = new Employeur("Patrique", "Lemieux", "marco.attia17+lemieux@gmail.com","4383006589" ,"popo123", "Cisco", programme1);
        Employeur employeur2 = new Employeur("Pierre", "Lacroix", "marco.attia17+lacroix@gmail.com","4387996589","popo123", "Norton", programme2);
        ...
        Internshipmanager internshipmanager = new Internshipmanager("Jean","Dupont", "4387996589",  "marco.attia17+dupont@gmail.com", "popo", programme1);
