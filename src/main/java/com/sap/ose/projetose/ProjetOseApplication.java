...
public class ProjetOseApplication implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        File file = new File(1L,"hello".getBytes(StandardCharsets.UTF_8),"SignContract.pdf",State.ACCEPTED, null, null);
        ...
        TemplateContractDto templateContractDto = new TemplateContractDto(LocalDate.now().toString(), true, file.getId(), file.getFileName(), file.getContent());
