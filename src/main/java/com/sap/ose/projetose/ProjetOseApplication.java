...
public class ProjetOseApplication implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        InternOfferDto internOfferDto3 = internOfferService.saveInterOfferJob(internOfferDto2);
        ...
        StageDto stage = new StageDto(0L, 1L, internOfferDto3, State.DECLINED, State.ACCEPTED);
        StageDto stage2 = new StageDto(0L, 2L, internOfferDto3, State.ACCEPTED, State.ACCEPTED);
        StageDto stage3 = new StageDto(0L, 2L, internOfferDto3, State.DECLINED, State.ACCEPTED);
        StageDto stage4 = new StageDto(0L, 2L, internOfferDto3, State.DECLINED, State.DECLINED);
