...
class InternshipCandidatesControllerDiffblueTest {
    @Autowired
    ...
    void testGetPendingCandidates2() throws Exception {
        ...
        MockMvcBuilders.standaloneSetup(internshipCandidatesController)
                ...
                .andExpect(MockMvcResultMatchers.content()
                        .string(
                                "[{\"id\":0,\"etudiant\":null,\"internOfferJob\":null,\"files\":null,\"state\":null,\"date\":null}]"));
    }
    ...
    void testDeclineIntershipCandidate() throws Exception {
        when(internshipCandidatesService.declineCandidates(Mockito.<Long>any())).thenReturn(new InternshipCandidatesDto());
        MockHttpServletRequestBuilder requestBuilder = MockMvcRequestBuilders
    ...
    void testGetInternshipCandidatesByOfferId() throws Exception {
        when(internshipCandidatesService.getInternshipCandidatesByIds(Mockito.<String>any())).thenReturn(new ArrayList<>());
        MockHttpServletRequestBuilder requestBuilder = MockMvcRequestBuilders
    ...
    void testGetIntershipCandidate() throws Exception {
        ...
        MockHttpServletRequestBuilder requestBuilder = MockMvcRequestBuilders.get("/api/intershipCandidates/getCandidats");
        MockMvcBuilders.standaloneSetup(internshipCandidatesController)
                .build()
                .perform(requestBuilder)
                .andExpect(MockMvcResultMatchers.status().isFound())
    ...
    void testSaveIntershipCandidate() throws Exception {
        ...
        MockHttpServletRequestBuilder requestBuilder = MockMvcRequestBuilders.post("/api/intershipCandidates/saveCandidats")
