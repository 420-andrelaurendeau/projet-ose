...
class EmployeurControllerTest {
    ...
    void testSaveEmployeur() throws Exception {
        Optional<EmployeurDTO> ofResult = Optional.of(new EmployeurDTO(1, "Nom", "Prenom", "jane.doe@example.org",
                "6625550144", "iloveyou", "Nom Entreprise", "Programme"));
        ...
        employeurDTO.setProgramme("Programme");
                ...
                .andExpect(MockMvcResultMatchers.content()
                        .string(
                                "{\"id\":1,\"nom\":\"Nom\",\"prenom\":\"Prenom\",\"email\":\"jane.doe@example.org\",\"phone\":\"6625550144\",\"password\""
                                        + ":\"iloveyou\",\"nomEntreprise\":\"Nom Entreprise\",\"programme\":\"Programme\"}"));
    }
}
