...
import {
    validateDescription, validateEndDate, validateFile,
    validateLocation, validateSalary, validateStartDate,
    validateTitle
...
const InternshipOfferForm: React.FC<any> = ({}) => {
    ...
    const handleFormChange = (e: React.ChangeEvent<HTMLInputElement | HTMLSelectElement | HTMLTextAreaElement>) => {
        ...
        if (name === "programme") {
            // Trouvez le programme sélectionné à partir de l'état des programmes
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            // Traitez la réponse ou mettez à jour l'état du composant en conséquence
        } catch (error) {
                            ...
                            <div className='block sm:flex space-x-0 sm:space-x-4 space-y-4 sm:space-y-0'>
                                ...
                                <div className='sm:w-1/2 sm:w-1/2'>
                                    ...
                                    <select name="programme"
                                        ...
                                        <option value="default" disabled>{t('formField.InternshipOfferForm.program.placeholder')}</option>
