    ...
    return (
        <div className="flex justify-center items-center min-h-screen max-md:pt-24">
            <div
                ...
                />
                <div
                    className="md:relative bg-white rounded-lg p-6 w-full max-w-xl dark:bg-dark border border-gray dark:border-darkgray">
                            ...
                            <div
                                ...
                                <div className="flex flex-col items-center justify-center py-10 text-center">
                                    <FontAwesomeIcon icon={faUpload}
                                                     className="w-14 h-auto text-blue dark:text-orange"/>
