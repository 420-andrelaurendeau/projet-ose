...
const ViewPDFModal = (props:any) => {
    ...
    return (
        ...
        <div className="flex justify-center items-center min-h-screen max-md:pt-24">
            <div className={`${props.ismodal ? "fixed z-50 top-0 left-0 bg-black dark:bg-gray bg-opacity-50 dark:bg-opacity-80 cursor-pointer": "rounded bg-white dark:bg-dark"} w-full h-full p-12`} onClick={
                () => {
                    if (props.ismodal) {
