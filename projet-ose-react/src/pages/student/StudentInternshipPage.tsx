                ...
                <div className="pt-24 flex-row flex md:justify-center space-x-4">
                    ...
                    >
                        <div className="flex space-x-2 items-center h-16 w-auto">
                            <div
                                className="bg-blue dark:bg-orange rounded-full h-12 w-12 flex items-center justify-center">
                                <FontAwesomeIcon icon={faMicrophone} className="group-hover:text-white dark:text-white"
                                                 size="lg"/>
                            </div>
                            <div className="pl-2">
                                <p className="text-blue dark:text-orange">{fields.Header.interview.text}</p>
                            </div>
                            {interviews.length > 0 ? <p className="text-black dark:text-white">{interviews.length}</p> : <p className="text-black dark:text-white">0</p> }
                        </div>
                    </NavLink>
